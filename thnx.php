	...
	foreach ($items as $item) {
		...
		foreach($sizes as $size){
			if($size['size'] == $item['size']){
				...
				$newSizes[] = ['size' => $size['size'], 'quantity' => $q];
			} else {
				$newSizes[] = ['size' => $size['size'], 'quantity' => $size['quantity']];
			}
		}
...
//update cart
	...
	<p>
		Your card has been successfully charged <?=money($grand_total);?>. You have been emailed a receipt.
		Please check your spam folder if it is not in your inbox. Additionally you can print this page as a receipt
	</p>
